...
export default function CppOutput({ cppCode, handleCopy, handleDownload, darkMode }) {
    ...
    return (
        <div className="flex flex-col gap-4">
            <div className={`w-full h-24 rounded px-4 flex flex-col gap-2 justify-center border-2 ${darkMode ? "border-white border-dashed" : "border-black border-dashed bg-white"}`}>
