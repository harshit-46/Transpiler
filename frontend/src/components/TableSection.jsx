        ...
        <div className={`max-w-7xl mx-auto p-6 md:px-10 md:pb-10 rounded-2xl shadow-md space-y-10 ${darkMode ? "text-white bg-gray-800 border border-white" : "text-black bg-white border border-black"}`}>
            <div className="flex flex-col md:flex-row justify-center items-center gap-10">
                <div className="flex-1">
                    ...
                    <p className={`text-base md:text-lg ${darkMode ? "text-white" : "text-black"} mb-3`}>
                    ...
                    <ol className={`list-decimal list-inside space-y-2 ${darkMode ? "text-white" : "text-black"}`}>
            ...
            <div className="overflow-x-auto">
                ...
                <table className={`min-w-full text-left text-sm ${darkMode ? "border border-white" : "border border-gray-300"}`}>
                    <thead className="bg-gray-200">
                        <tr>
                            <th className="border border-gray-300 px-4 py-2 font-semibold">Characteristic</th>
                            <th className="border border-gray-300 px-4 py-2 font-semibold">Python</th>
                            <th className="border border-gray-300 px-4 py-2 font-semibold">C++</th>
                        </tr>
                    </thead>
                    <tbody className="bg-white">
                        {[
                            ...
                            <tr key={index}>
                                <td className="border border-gray-300 px-4 py-2 font-medium">{row.title}</td>
                                <td className="border border-gray-300 px-4 py-2">{row.python}</td>
                                <td className="border border-gray-300 px-4 py-2">{row.cpp}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
